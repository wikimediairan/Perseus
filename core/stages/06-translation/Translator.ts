 ...
 * see core/stages/05-chunking/segmentProtocol.ts. `translateChunk` renders and
...
import type { PromptManager } from "@core/stages/06-translation/PromptManager";

// Re-exported from their new home (core/stages/05-chunking/segmentProtocol.ts) so existing
