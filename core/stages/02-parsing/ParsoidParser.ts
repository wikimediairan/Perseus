 ...
 *                             — see translation-sessions/types.ts. Never
...
import type { LoadedArticle } from "@core/stages/01-input/InputLoader";
import { buildCitationRegistry } from "@core/stages/02-parsing/citationRegistryBuilder";
import { flattenToPlaceholderText } from "@core/stages/02-parsing/placeholders";
 ...
 * (see translation-sessions/types.ts) is the sole input, never the article's
