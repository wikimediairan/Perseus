...
import { renderTranslatedChunkForEditing } from "@perseus/core";
      ...
      <CardContent className="flex flex-col gap-3">
        <div className="flex flex-wrap items-center gap-2">
          ...
          >
            {promptCopied
              ? t("common.copied")
              : t("chunkWorkspace.copyGeneralPrompt")}
          </Button>
          <Button
        ...
        <div className="flex flex-col gap-2">
          {chunks.map((chunk, i) => (
            <ChunkRow
              ...
              translatedText={renderTranslatedChunkForEditing(
                chunk,
                chunkState.translatedByNodeId,
              )}
            />
          ))}
        </div>
        ...
        >
          {generateBusy
            ? t("chunkWorkspace.generating")
            : t("chunkWorkspace.generateWikitext")}
        </Button>
      </CardContent>
    </Card>
  );
